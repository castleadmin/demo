...
export function PrivacyPolicy(_props: PrivacyPolicyProps) {
  return (
    <div className={styles['privacy-policy-page']}>
      <Card sx={{ bgcolor: 'menu.main', boxShadow: 4 }}>
        <CardContent>
          <h1 className={styles['privacy-policy-content-start']}>
            Privacy Policy
          </h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Adventials.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Third-party Service</strong> refers to any website or
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Adventials, accessible from{' '}
                <a href="/" rel="noreferrer noopener" target="_blank">
                  https://adventials.com
                </a>
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            Service through the following Third-party Services:
          </p>
          <ul>
            <li>Google</li>
            <li>GitHub</li>
          ...
          <p>
            ...
            associated with Your Third-Party Service's account, such as Your
            name, Your email address, Your activities or Your contact list
            associated with that account.
          </p>
          <p>
            You may also have the option of sharing additional information with
            the Company through Your Third-Party Service's account. If You
          ...
          <ul>
            ...
            <li>
              ...
              register through a Third-Party Service, Your contacts on the
              Third-Party Service may see Your name, profile, pictures and
          ...
          <ul>
            <li>By email: twillig@castleadmin.com</li>
          </ul>
        </CardContent>
      </Card>
    </div>
